  ...
  return (
    <>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {activeSection === "home" && <Hero lang={lang} setSection={setSection} />}
          {activeSection === "about" && <About lang={lang} setSection={setSection} />}
          {activeSection === "services" && <Services lang={lang} />}
          {activeSection === "blog" && <Blog lang={lang} />}
          {activeSection === "reviews" && <Reviews lang={lang} />}
          {activeSection === "faq" && <FAQ lang={lang} />}
          {activeSection === "contact" && <Contact lang={lang} />}
          {activeSection === "donate" && <Donate lang={lang} />}
          <DIVIDER />
          <Footer lang={lang} />
        </motion.main>
      </AnimatePresence>
